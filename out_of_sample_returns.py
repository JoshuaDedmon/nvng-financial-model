...
sp500_2022_return = (data["Close"][-1] / data["Close"][0]) - 1

x = [1, 12]
y = [1000, 1000 * (1 + sp500_2022_return)]
...
plt.title("NVNG Model vs. S&P 500 for 2022")
plt.xlabel("Months")
plt.ylabel("Investment Value")

plt.legend(["NVNG Model (EOY = $933.68)", "S&P 500 (EOY = $800.47)"])
